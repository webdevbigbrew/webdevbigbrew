  ...
  if($upload_ok == 0){
     echo '<script>alert("sorry your file is doesn\'t uploaded. Please try again")</script>';
      ...
      if($productname != "" && $price !=""){
          ...
          $sql = "INSERT INTO product(product_name,product_desc,price,discount,product_image)
          VALUES('$productname','$product_desc',$price,$discount,'$product_image')";
...
<body>
    ...
    <section id="upload_container">
        <form action="upload.php" method="POST" enctype="multipart/form-data" >
            ...
            <input type="text" name="product_desc" id="product_desc" placeholder="Product Description" required>
